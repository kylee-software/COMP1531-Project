...
#     for name in names:
#         channels_create_v2(auth_user_id, name, False)
#     returnDict = channels_list_v1(auth_user_id)
...
#     auth_user_id02 = auth_register_v2(
#         "test02@unsw.com", 'testPassword16', 'Test02', "User")['auth_user_id']
#     for name in names:
#         channels_create_v2(auth_user_id, name, False)
#     channels_create_v2(auth_user_id02, 'testChannel06', False)
