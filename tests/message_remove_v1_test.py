...
def test_remove_messages(auth_user, channel_id, dm_id):
    clear_v1()
    message_send_v2(auth_user, channel_id, "Hi!")
...
def test_unauthorised_auth_user(member, channel_id, dm_id):
    clear_v1()
