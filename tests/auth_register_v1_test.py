import pytest
# import function import clear write fixtures 
...
# Test if first name is stored correctly 
def test_first_name_stored_in_dictionary():
    pass 

# Test if last name is stored correctly 
def test_if_last_name_stored_in_dictionary():
    pass 

# Test if password is stored correctly 
...
# test for same name multiple times and then 